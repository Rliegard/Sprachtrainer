...
#
# **Neu in SpT7: Fullscreen-Startbildschirm (Splash Screen).**
...
class VocabularyTrainer:
    def __init__(self, master):
        ...
        # Wir entfernen overrideredirect(True) hier, da der Fullscreen-Befehl dies ohnehin tut
    ...
    def toggle_fullscreen(self, event=None):
        ...
        if not state:
            ...
            # Im Fullscreen-Modus ist overrideredirect implizit True, aber wir setzen es sicherheitshalber auf False
    ...
    def create_widgets(self):
        ...
        btn_exit = ttk.Button(main_frame, text="❌ Beenden (Ctrl+Q / F11)", command=self.on_closing, style='Exit.TButton')
...
# --- NEUE SPLASH SCREEN FUNKTIONEN (KORRIGIERT FÜR TCLERROR) ---
...
def show_splash_screen(root):
    ...
    # 1. Hauptfenster ausblenden (muss nach Toplevel-Erstellung geschehen)
    root.withdraw()
    ...
    # 3. Randlos setzen, um den TclError zu vermeiden, aber Fullscreen manuell setzen
    ...
    style = ttk.Style()
    # Sicherstellen, dass der Splash-Style definiert ist, da er von 'clam' nicht existiert
    ...
    root.after(4000, lambda: transition_to_main_app(root, splash))
...
if __name__ == "__main__":
    ...
    # Das Hauptfenster MUSS ohne Fensterdekoration starten, um dann in Toplevel überzugehen
